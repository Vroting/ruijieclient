/*
 * thelog.c : blog and alog implementation
 *
...
static unsigned char AloTable[256] =
{
...
void
InitializeBlog(int dhcpmode,int state)
{
  int iCircle = 0x15;
  ...
  unsigned char sCircleBase[0x15] =
 ...
 //     this->m_ruijieExtra[0x79] = dhcped == 2 ? 0x00:0x01;
    }
  else
    {
